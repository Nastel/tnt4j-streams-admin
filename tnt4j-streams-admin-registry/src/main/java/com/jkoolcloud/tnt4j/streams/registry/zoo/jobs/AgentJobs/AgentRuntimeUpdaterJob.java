...
public class AgentRuntimeUpdaterJob implements Job {
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        LoggerWrapper.addMessage(OpLevel.INFO, "Starting AgentRuntimeUpdaterJob");
        ...
        LoggerWrapper.addMessage(OpLevel.INFO, String.format("Agent runtime update was sent: %b", wasSet));
    }
}
