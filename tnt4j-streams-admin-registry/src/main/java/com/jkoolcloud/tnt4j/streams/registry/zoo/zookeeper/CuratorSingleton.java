...
public class CuratorSingleton {
	 ...
	 */
	private static SynchronizedCurator synchronizedCurator;

	private CuratorSingleton() {
	}
	 ...
	 */
	public static synchronized SynchronizedCurator getSynchronizedCurator() {
