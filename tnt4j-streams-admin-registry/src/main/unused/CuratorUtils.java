...
public class CuratorUtils {
	...
	static {
		...
		String zklogin = properties.getProperty("zklogin");
		String zkpass = properties.getProperty("zkpass");

		curatorFramework = CuratorFrameworkFactory.builder().connectString(connectString)
				.retryPolicy(new RetryForever(100)).authorization("digest", (zklogin + ":" + zkpass).getBytes())
				.build();
