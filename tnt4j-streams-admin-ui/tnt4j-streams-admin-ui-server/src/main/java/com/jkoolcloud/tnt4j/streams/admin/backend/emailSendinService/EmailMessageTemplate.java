...
public class EmailMessageTemplate {
	...
	public void getNewUserRegistration(String name, String recipientEmail, String emailConfirmationLink) {
		...
		String messageContent = "<meta http-equiv=\"Content-Type\"  content=\"text/html charset=UTF-8\" />\n"
				...
				+ "<div style=\"color:#000000;\">" + "<h2>Hello " + name + ",</h2>\n" + "  <br>\n"
				...
				+ "font-weight: bold; color: #ffffff; padding: 10px; margin: 20px;\" " + "href=" + emailConfirmationLink
				+ "> Confirm E-mail </a></div>\n"
				+ "  <p style=\"font-size:12px;\"><br> If you are having trouble clicking the confirmation button, try using the URL below.<br><br>"
				+ emailConfirmationLink + "</p>" + "</div>";
