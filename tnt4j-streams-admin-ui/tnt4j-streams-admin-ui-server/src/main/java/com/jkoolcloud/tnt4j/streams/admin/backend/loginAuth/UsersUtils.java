...
public class UsersUtils {
	 ...
	 * 
	 * @param clustersAndRights
	 *            from front end form clusters and rights map
	 * @param username
	 *            the new username
	 * @param password
	 ...
	 */
	public void addUser(HashMap<String, List> clustersAndRights, String username, String password, boolean decryptPass,
			boolean admin) throws AuthenticationException {
		...
		try {
			for (Map.Entry<String, List> entry : clustersAndRights.entrySet()) {
				...
				LOG.info("Add a new user to: " + key + ". With the ACl set to : " + ACLConstructed
						+ "and the action rights for user set to: " + adminRights);
	 ...
	 * 
	 * @param pathsToNode
	 *            path to clusters from which users should be removed
	 * @param username
	 *            the user to remove
	 */
	 ...
	 * 
	 * @param clustersAndRights
	 *            a map of clusters with their rights
	 * @param username
	 *            the username to edit
	 * @param password
	...
	private void updateUserAclCall(HashMap<String, List> clustersAndRights, String username) {
		...
		try {
			for (Map.Entry<String, List> entry : clustersAndRights.entrySet()) {
				...
				LOG.info("Add a new user to: " + cluster + ". With the ACl set to : " + aclList
						+ "and the action rights for user set to: " + adminRights);
				if (aclRights > 0) {
	 ...
	 * 
	 * @param availableClusters
	 *            list of clusters to get users from
	 * @return
	 */
	 ...
	 * 
	 * @param availableClusters
	 *            list of clusters to get user info from
	 * @return
	 */
	 ...
	 *            the input list
	 * @param valueNeeded
	 *            the value to find inside the list
	 * @return
	 */
	 ...
	 * @param loginCache
	 *            reference to the loginCache object/class
	 * @return
	 */
