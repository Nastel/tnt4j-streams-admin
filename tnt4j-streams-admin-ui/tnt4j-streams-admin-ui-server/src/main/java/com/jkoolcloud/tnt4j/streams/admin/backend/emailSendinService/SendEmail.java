...
public class SendEmail {
	...
	public SendEmail(boolean emailWithAttachment, String recipientEmail, String messageSubject, String messageContent,
	 ...
	 * 
	 * @param senderEmail
	 *            The gmail email from which the data will be sent.
	 * @param senderName
	 *            Repeat the email for username field.
