...
public class StreamsAdminLogin implements LoginModule {
	...
	public boolean login() throws LoginException {
		...
		// LOG.info("Is the user authenticated already and do not need any more AUTH on login method: "+
		// authenticateNow);
		if (authenticateNow) {
			userGroups = getRoles();
		...
		if (handler == null) {
			throw new LoginException(
					"Error: no CallbackHandler available to receive authentication information from the user");
		}
		...
		try {
			...
			if (username == null || username.isEmpty() || password.isEmpty()) {
				...
				// if ( (username.equals("test") && password.equals("test")) || (username.equals("admin") &&
