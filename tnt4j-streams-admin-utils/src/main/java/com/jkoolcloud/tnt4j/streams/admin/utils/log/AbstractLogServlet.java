...
/**
 * Abstract servlet, capable to access one type logs.
 */
public abstract class AbstractLogServlet extends HttpServlet {
	private static final long serialVersionUID = -809920474504813153L;
	...
	public void init(ServletConfig config) throws ServletException {
		...
		appender = (StringBufferAppender) logger.getAppender(getAppenderName());
		// appender.start();
	}
